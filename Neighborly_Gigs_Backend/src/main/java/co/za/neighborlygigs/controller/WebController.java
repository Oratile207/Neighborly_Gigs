...
public class WebController {
    ...
    public String registerForm(Model model) {
        System.out.println("✅ REGISTER PAGE LOADED"); // ← Add this
    ...
    public String dashboard(@AuthenticationPrincipal CustomUserDetails currentUser, Model model) {
        ...
        // Mock stats (replace later with real service)
    ...
    public String jobList(Model model) {
        ...
        model.addAttribute("searchQuery", "");
        return "jobs"; // matches template: jobs.html
    }
    ...
    public String taskDetail(
        ...
        model.addAttribute("user", currentUser != null); // for Thymeleaf conditional: ${user}
        return "task-detail";
    }
